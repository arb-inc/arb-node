...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/filings/documents/delete',
  operationId: 'deleteFiledDocument',
};

export const tool: Tool = {
  name: 'delete_filings_documents',
  description:
...
export const handler = async (client: ArbInc, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.filings.documents.delete(body)));
};
